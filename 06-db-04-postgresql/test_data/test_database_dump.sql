...
--
-- Name: orders_bkp; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.orders_bkp (
    id integer NOT NULL,
...
ALTER TABLE public.orders_bkp OWNER TO postgres;
...
ALTER SEQUENCE public.orders_id_seq OWNED BY public.orders_bkp.id;
...
--
-- Name: orders_bkp id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_bkp ALTER COLUMN id SET DEFAULT nextval('public.orders_id_seq'::regclass);


--
-- Data for Name: orders_bkp; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.orders_bkp (id, title, price) FROM stdin;
1	War and peace	100
...
--
-- Name: orders_bkp orders_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders_bkp
